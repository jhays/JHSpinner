Pod::Spec.new do |s|
  s.name             = "JHSpinner"
  s.version          = "0.1.0"
  s.summary          = "A unique animated loading spinner for iOS"
  s.description      = <<-DESC
  A unique animated loading spinner UIView subclass for iOS. Includes several customization options to change the overlay, colors, text, and animation speed. Also includes a determinate spinner for progress-bar style loading or file upload.
                       DESC
